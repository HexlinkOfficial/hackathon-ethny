...
import type {
  ...
  HexlinkContractFactoryInterface,
} from "../HexlinkContractFactory";
...
type HexlinkContractFactoryConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: HexlinkContractFactoryConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class HexlinkContractFactory__factory extends ContractFactory {
  constructor(...args: HexlinkContractFactoryConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
      super(_abi, _bytecode, args[0]);
    }
    this.contractName = "HexlinkContractFactory";
  }

  deploy(
    owner: string,
    overrides?: Overrides & { from?: string | Promise<string> }
  ): Promise<HexlinkContractFactory> {
    return super.deploy(
      owner,
      overrides || {}
    ) as Promise<HexlinkContractFactory>;
  }
  ...
  attach(address: string): HexlinkContractFactory {
    return super.attach(address) as HexlinkContractFactory;
  }
  connect(signer: Signer): HexlinkContractFactory__factory {
    return super.connect(signer) as HexlinkContractFactory__factory;
  }
  static readonly contractName: "HexlinkContractFactory";
  public readonly contractName: "HexlinkContractFactory";
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): HexlinkContractFactoryInterface {
    return new utils.Interface(_abi) as HexlinkContractFactoryInterface;
  }
  static connect(
    address: string,
