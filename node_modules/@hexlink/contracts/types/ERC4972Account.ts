...
export interface ERC4972AccountInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "getERC4972Registry",
    values?: undefined
  ): string;
...
export type NameOwnerUpdatedEvent = TypedEvent<[string], { arg0: string }>;

export type NameOwnerUpdatedEventFilter =
  TypedEventFilter<NameOwnerUpdatedEvent>;

export type NameUpdatedEvent = TypedEvent<[string], { name: string }>;
...
export interface ERC4972Account extends BaseContract {
  ...
  filters: {
    "NameOwnerUpdated(address)"(
      arg0?: string | null
    ): NameOwnerUpdatedEventFilter;
