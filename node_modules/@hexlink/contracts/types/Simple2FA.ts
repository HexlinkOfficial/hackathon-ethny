...
export interface Simple2FAInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "addSecondFactor",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "getSecondFactor",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "removeSecondFactor",
    values: [string]
  ): string;
...
export type SecondFactorAddedEvent = TypedEvent<[string], { arg0: string }>;

export type SecondFactorAddedEventFilter =
  TypedEventFilter<SecondFactorAddedEvent>;

export type SecondFactorRemovedEvent = TypedEvent<[string], { arg0: string }>;

export type SecondFactorRemovedEventFilter =
  TypedEventFilter<SecondFactorRemovedEvent>;
...
export interface Simple2FA extends BaseContract {
  ...
  filters: {
    "SecondFactorAdded(address)"(
      arg0?: string | null
    ): SecondFactorAddedEventFilter;
    SecondFactorAdded(arg0?: string | null): SecondFactorAddedEventFilter;

    "SecondFactorRemoved(address)"(
      arg0?: string | null
    ): SecondFactorRemovedEventFilter;
