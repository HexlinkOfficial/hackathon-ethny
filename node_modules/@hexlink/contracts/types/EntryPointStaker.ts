...
export interface EntryPointStakerInterface extends utils.Interface {
  contractName: "EntryPointStaker";
  functions: {
...
export interface EntryPointStaker extends BaseContract {
  contractName: "EntryPointStaker";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EntryPointStakerInterface;
