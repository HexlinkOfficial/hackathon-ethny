...
export declare namespace ServiceRegistry {
    ...
    type PriceInfoStructOutput = [BigNumber, BigNumber] & {
        price: BigNumber;
...
export interface ServiceRegistryInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "MIN_STAKE_PER_USER", values?: undefined): string;
    encodeFunctionData(functionFragment: "addDeposit", values: [string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "closeSubscription", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "openSubscription", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "setPrice", values: [string, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "MIN_STAKE_PER_USER", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "addDeposit", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "closeSubscription", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getDeposit", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getMetadata", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getPrice", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getToken", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "openSubscription", data: BytesLike): Result;
...
export interface ServiceRegistry extends BaseContract {
    ...
    functions: {
        ...
        addDeposit(token: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        closeSubscription(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        getDeposit(token: string, overrides?: CallOverrides): Promise<[BigNumber]>;
        getMetadata(overrides?: CallOverrides): Promise<[string]>;
        getPrice(token: string, overrides?: CallOverrides): Promise<[ServiceRegistry.PriceInfoStructOutput]>;
        getToken(overrides?: CallOverrides): Promise<[string]>;
        openSubscription(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setMetadata(metadata_: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setMinDeposit(token: string, minDeposit: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setPrice(token: string, price: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        stake(amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        subscribe(service: string, token: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        MIN_STAKE_PER_USER(overrides?: CallOverrides): Promise<BigNumber>;
        addDeposit(token: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        ...
        setMinDeposit(token: string, minDeposit: BigNumberish, overrides?: CallOverrides): Promise<void>;
        setPrice(token: string, price: BigNumberish, overrides?: CallOverrides): Promise<void>;
        stake(amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        subscribe(service: string, token: string, overrides?: CallOverrides): Promise<void>;
    ...
    populateTransaction: {
        MIN_STAKE_PER_USER(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        addDeposit(token: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        ...
        getDeposit(token: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
