...
export interface AccountInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "initialize", values: [BytesLike, string]): string;
...
export interface Account extends BaseContract {
    ...
    functions: {
        ...
        "executeBatch(address[],bytes[])"(dest: string[], func: BytesLike[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        "executeBatch(address[],uint256[],bytes[])"(dest: string[], value: BigNumberish[], func: BytesLike[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        initialize(name: BytesLike, owner: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "executeBatch(address[],bytes[])"(dest: string[], func: BytesLike[], overrides?: CallOverrides): Promise<void>;
        "executeBatch(address[],uint256[],bytes[])"(dest: string[], value: BigNumberish[], func: BytesLike[], overrides?: CallOverrides): Promise<void>;
        getDeposit(overrides?: CallOverrides): Promise<BigNumber>;
        getERC4972Registry(overrides?: CallOverrides): Promise<string>;
        getName(overrides?: CallOverrides): Promise<string>;
        getNameOwner(overrides?: CallOverrides): Promise<string>;
        ...
        getSecondFactor(overrides?: CallOverrides): Promise<string>;
        implementation(overrides?: CallOverrides): Promise<string>;
        initialize(name: BytesLike, owner: string, overrides?: CallOverrides): Promise<void>;
        proxiableUUID(overrides?: CallOverrides): Promise<string>;
