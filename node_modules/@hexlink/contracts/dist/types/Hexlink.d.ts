...
export interface HexlinkInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "addStake", values: [string, BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "deploy", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "getAccountImplementation", values?: undefined): string;
    encodeFunctionData(functionFragment: "getAuthRegistry", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "getNameService", values?: undefined): string;
    encodeFunctionData(functionFragment: "getOwnedAccount", values: [BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "upgradeImplementation", values: [string]): string;
    encodeFunctionData(functionFragment: "upgradeTo", values: [string]): string;
    encodeFunctionData(functionFragment: "upgradeToAndCall", values: [string, BytesLike]): string;
    encodeFunctionData(functionFragment: "withdrawStake", values: [string, string]): string;
    decodeFunctionResult(functionFragment: "addStake", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "deploy", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getAccountImplementation", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getAuthRegistry", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "getNameService", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getOwnedAccount", data: BytesLike): Result;
...
export interface Hexlink extends BaseContract {
    ...
    functions: {
        addStake(entrypoint: string, toStake: BigNumberish, unstakeDelaySec: BigNumberish, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        deploy(name: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        initialize(owner: string, accountImpl: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        owner(overrides?: CallOverrides): Promise<[string]>;
        proxiableUUID(overrides?: CallOverrides): Promise<[string]>;
        transferOwnership(account: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        unlockStake(entrypoint: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        upgradeImplementation(impl: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        withdrawStake(entrypoint: string, withdrawTo: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    addStake(entrypoint: string, toStake: BigNumberish, unstakeDelaySec: BigNumberish, overrides?: PayableOverrides & {
    ...
    callStatic: {
        addStake(entrypoint: string, toStake: BigNumberish, unstakeDelaySec: BigNumberish, overrides?: CallOverrides): Promise<void>;
        ...
        getOwnedAccount(name: BytesLike, overrides?: CallOverrides): Promise<string>;
        implementation(overrides?: CallOverrides): Promise<string>;
        initialize(owner: string, accountImpl: string, overrides?: CallOverrides): Promise<void>;
        owner(overrides?: CallOverrides): Promise<string>;
        proxiableUUID(overrides?: CallOverrides): Promise<string>;
        transferOwnership(account: string, overrides?: CallOverrides): Promise<void>;
        unlockStake(entrypoint: string, overrides?: CallOverrides): Promise<void>;
        upgradeImplementation(impl: string, overrides?: CallOverrides): Promise<void>;
        upgradeTo(newImplementation: string, overrides?: CallOverrides): Promise<void>;
        upgradeToAndCall(newImplementation: string, data: BytesLike, overrides?: CallOverrides): Promise<void>;
        withdrawStake(entrypoint: string, withdrawTo: string, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
        "AccountDeployed(bytes32,address)"(name?: BytesLike | null, account?: string | null): AccountDeployedEventFilter;
        AccountDeployed(name?: BytesLike | null, account?: string | null): AccountDeployedEventFilter;
    ...
    estimateGas: {
        ...
        getOwnedAccount(name: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        getAccountImplementation(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        getOwnedAccount(name: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
