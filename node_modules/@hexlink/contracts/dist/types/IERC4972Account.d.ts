...
export interface IERC4972AccountInterface extends utils.Interface {
    contractName: "IERC4972Account";
    functions: {
...
export interface IERC4972Account extends BaseContract {
    contractName: "IERC4972Account";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IERC4972AccountInterface;
